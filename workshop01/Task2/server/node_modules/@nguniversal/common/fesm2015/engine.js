...
function createDocument(html) {
  const document = parse5$1.parse(html, PARSE5_OPTS);
...
const defaultLogger = {
  ...
  warn(msg) {
    console.warn(chalk$1.yellow(msg));
  },
  ...
  info(msg) {
    console.info(chalk$1.bold.blue(msg));
  },
...
class Critters {
  ...
  readFile(filename) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (fs && fs.readFile) {
        ...
        fs__default.readFile(filename, 'utf8', callback);
      }
    });
  }
  /**
  ...
  getCssAsset(href) {
    try {
      ...
      const filename = path$1.resolve(outputPath, normalizedPath);
      let sheet;
    ...
    try {
      ...
      if (options.pruneSource) {
        ...
        if (styleInlinedCompletely) {
          ...
          afterText = `, reducing non-inlined size ${percent | 0}% to ${prettyBytes$1(sheetInverse.length)}`;
        }
